...
<html lang="en">
	<head>
	    ...
	    <title>Online Marketplace | Payment Method</title>
...
<form action="https://uat.esewa.com.np/epay/main" method="POST">
    ...
    <input value="ee2c3ca1-696b-4cc5-a6be-<?php echo generateRandomString(12) ?>" name="pid" type="hidden">
    <input value="http://localhost/omp/success.php?success=true" type="hidden" name="su">
    <input value="http://localhost/omp/success.php?success=false" type="hidden" name="fu">
