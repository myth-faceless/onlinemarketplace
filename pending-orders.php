...
header('location:login.php');
	...
	if (isset($_GET['id'])) {
		...
		mysqli_query($con,"delete from orders  where userId='".$_SESSION['id']."' and paymentStatus is false and id='".$_GET['id']."' ");
		;
...
orders.id as oid from orders join products on orders.productId=products.id where orders.userId='".$_SESSION['id']."' and orders.paymentStatus is not true");
