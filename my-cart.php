...
$stmt->bind_param("sss", $_SESSION['id'], $qty, $val34);
// $stmt->execute();
...
<div class="col-md-8 col-sm-4 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Save or Update</button>
					<?php } ?>
...
<div class="col-md-4 col-sm-6 cart-shopping-total">
    ...
    <input type="text" name="product-amount" value="<?php echo $totalprice;?>" hidden>
    <input type="submit" name="submit" class="btn btn-primary" value="PROCEED TO CHECKOUT">
</form> -->
	<!-- <a href="payment-method.php?total=<?php echo $totalprice; ?>" class="btn btn-primary">PROCEED TO CHECKOUT</a> -->
	<form action="payment-method.php" method="POST">
    ...
    <!-- <button type="submit" name="ordersubmit" class="btn btn-primary">PROCEED TO CHECKOUT</button> -->
	<!-- <form action="payment-method.php" method="POST">
    <input type="hidden" name="total" value="<?php echo $_SESSION['tp']="$totalprice". ".00"; ?>">
    <button type="submit" name="ordersubmit" class="btn btn-primary">PROCEED TO CHECKOUT</button>
</form> -->
